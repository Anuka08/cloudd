...
/**
 * <code>SparseVector</code> stores a sparse vector in a memory efficient
 * manner. It stores the elements of a vector as a list of index:value pairs.
 *
...
public class SparseVector implements Serializable {
    ...
    /**
     * Computes dot product between this vector and the argument
     * <code>vector</code>
     *
     * @param vector
     * @return
