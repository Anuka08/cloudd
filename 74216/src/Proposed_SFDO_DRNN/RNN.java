...
public class RNN implements IAgentSupervised {

    private double init_weight_range = 0.14;
    ...
    public RNN(Random r, int input_dimension, int output_dimension, int cell_blocks, ArrayList<Double> opt_w) {
        ...
        for (int j = 0; j < cell_blocks + 1; j++) {
            for (int k = 0; k < output_dimension; k++) {
                weightsOut[k][j] = ((r.nextDouble() * 2 - 1) * init_weight_range) * opt_w.get(0);
            }
        }
    }
